...
En la práctica, el trabajo se organiza en torno a ciclos de descubrimiento: cada fase produce hallazgos que informan la siguiente. Las herramientas principales son GitHub issues, hitos y Architecture Decision Records (ADRs):
...
El proyecto se estructura en cinco hitos que corresponden a las fases de un proyecto de I+D aplicado:
...
Los hitos 1 y 2 corresponden a la fase exploratoria de la investigación. Los hitos 3 y 4 corresponden a la fase de diseño e implementación. El hito 5 corresponde a la evaluación. El capítulo de desarrollo sigue esta misma estructura, organizado en exploración técnica y decisiones de diseño, implementación del pipeline, e integración con la plataforma.
