...
\item La confianza declarada por los modelos no se calibró frente a resultados observados y no se interpreta como una medida fiable de calidad. Tampoco se estudió de forma sistemática la reproducibilidad de las salidas bajo la misma configuración.
\item La independencia de la plataforma se examinó con archivos locales y una prueba de concepto con Open edX. No se verificó mediante una segunda integración con otro LMS o foro, y el mecanismo de activación por eventos no se probó con suficiente amplitud para establecer su fiabilidad operativa. La función de publicación se probó con componentes simulados y no incluye una revisión previa del instructor, por lo que no se considera segura para la publicación automática.
