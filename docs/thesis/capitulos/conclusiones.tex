...
\begin{itemize}
	...
	\item Las salidas de los modelos pueden variar entre ejecuciones. No se estudió de forma sistemática la reproducibilidad de las clasificaciones, decisiones y respuestas bajo la misma configuración.
