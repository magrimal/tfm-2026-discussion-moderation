...
This work develops a facilitation system for asynchronous, text-based
academic discussions organized as discussion threads. The system is
based on large language models (LLMs), artificial-intelligence models trained on large human-language
...
Este trabajo desarrolla un sistema de facilitación para discusiones
académicas asíncronas basadas en texto y organizadas como hilos de
discusión. El sistema se basa en modelos de lenguaje de gran escala
(LLMs), modelos de inteligencia artificial
