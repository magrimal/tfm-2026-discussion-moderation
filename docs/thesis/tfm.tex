...
models (LLMs) and context engineering techniques. To analyze each
discussion, the system uses a sequence of agents that share execution
...
de lenguaje de gran escala (LLMs) y técnicas de ingeniería del
contexto (\textit{context engineering}).
Para analizar cada discusión, el sistema utiliza una secuencia de
agentes que comparten el estado de la ejecución, clasifican el hilo de discusión,
...
\palabrasClave{LLMs, facilitación de discusiones, educación en línea, context engineering}
\end{resumen}
...
\appendix
\input{capitulos/anexo-flujo-prototipo}
