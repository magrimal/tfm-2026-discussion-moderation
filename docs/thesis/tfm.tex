...
% biblatex registra su \AtEndPreamble antes que el de la clase. Cuando
% comprueba si hyperref está cargado, todavía no lo está, así que llama
% \blx@mknohyperref y deshabilita los links. La clase carga hyperref
% después, pero ya es tarde para biblatex.
% Solución: registramos nuestro \AtEndPreamble al final del preámbulo
% (corre después del de la clase, que es quien carga hyperref).
% En ese momento hyperref sí está disponible y \blx@mkhyperref activa
% el soporte completo de links en las citas.
\AtEndPreamble{%
  \@ifpackageloaded{hyperref}{\blx@mkhyperref}{}%
}
