...
```
status_code: 500, model_name: ministral-3:14b, body: {'message': "invalid character '\\n' in string literal", 'type': 'api_error', 'param': None, 'code': None}
```
